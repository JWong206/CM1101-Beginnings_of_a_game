...
def normalise_input(user_input):
    ...
    'help'
    """
    normalised = (remove_spaces(remove_punct(remove_spaces(user_input)))).lower()
    return(normalised)
...
def menu(exits):
    ...
    while is_valid_exit(exits, selection) == False:
        print('Input not recognised.')
        selection = normalise_input(input('Where do you want to go? '))
    else:
        return(selection)
